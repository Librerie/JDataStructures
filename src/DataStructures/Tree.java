...
public class Tree<T extends Comparable<T>>
{
    ...
    public int countNodes()
    {
        ...
        if (this != null)
        {
            countNodes = ((this.getLeft().countNodes()) + this.getRight().countNodes() + 1);
        }
        return countNodes;
    }
    ...
    public int heightTree()
    {
        ...
        else
        {
            ...
            {
                heightTree = (1 + res_left);
            }
            else
            {
                heightTree = (1 + res_right);
            }
        }
        return heightTree;
    }
    ...
    {
        return "Tree [left=" + left + ", right=" + right + ", value=" + value + ", countNodes()=" + countNodes() + ", countLeafs()=" + countLeafs()
                + ", heightTree()=" + heightTree() + ", depthTree()=" + depthTree() + ", isResearchTree()=" + isResearchTree() + "]";
    }
}
